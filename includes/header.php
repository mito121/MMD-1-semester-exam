...
<html lang="en">
    <head>
        ...
        <!-- fontawesome -> source: https://fontawesome.com/ -->
        <link href="../assets/css/fontawesome/css/all.css" rel="stylesheet" type="text/css"/>
        <!--<link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.11.2/css/all.css" rel="stylesheet" type="text/css"/>-->

        <!-- materialdesignicons -> source: https://material.io/ -->
        <!--<link href="../assets/css/material-design-icons/material-icons.css" rel="stylesheet" type="text/css"/>-->
        ...
        <header>
            <nav>
                <div class="nav-container">
                    <a href="https://portfolio.webnation.dk">
